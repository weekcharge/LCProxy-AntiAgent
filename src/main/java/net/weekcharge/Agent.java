...
public class Agent {
    public static void premain(String args, Instrumentation inst){
        System.out.println("Patching Lunar Client Proxy AntiAgent check...");
            ...
            public byte[] transform(ClassLoader loader, String targetClassName, Class<?> targetClass, ProtectionDomain protectionDomain, byte[] buffer) {
                ...
                for(MethodNode method : node.methods){
                    if(method.name.equals("check") && method.desc.equals("()V") && method.access == (Opcodes.ACC_PUBLIC | Opcodes.ACC_STATIC)) {
                        System.out.println("Found Lunar Client Proxy AntiAgent check method, patching... (" + targetClassName + ")");
                        ...
                        node.accept(writer);
                        System.out.println("Successfully patched Lunar Client Proxy AntiAgent");
